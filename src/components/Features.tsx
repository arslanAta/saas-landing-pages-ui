            ...
            <div className="container">
                ...
                <div className="">
                    <div className="grid grid-cols-3 gap-20 justify-center pt-14">
                        <div className=" space-y-4">
                            <img src="../img/collboration.png" alt="" className="" />
                        ...
                        <div className=" space-y-4">
                            <img src="../img/cloud.png" alt="" className="" />
                        ...
                        <div className=" space-y-4">
                            <img src="../img/daily.png" alt="" className="" />
                ...
                <div className="flex justify-between py-20 ">
                    ...
                    <div className="relative">
                        <img src="../img/gallery-icon.png" alt="" className="absolute left-[-60px] top-60" />
                        <img src="../img/chat-icon.png" alt=""  className="absolute left-[-120px] top-10"/>
                        <img src="../img/transfer-icon.png" alt="" className="absolute bottom-0 left-[-120px]"/>
